...
namespace Midnight_Commander.Windows
{
    public class Copier : IPopUp
    {
        ...
        public Copier(string from, string name)
        {
            this.Active = true;
            this.Source = from;
            this.Name = name;
        ...
        public void Draw()
        {
            ...
            Console.WriteLine("- Kopírovat -".PadLeft(Console.WindowWidth / 2 - 23).PadRight(60));
